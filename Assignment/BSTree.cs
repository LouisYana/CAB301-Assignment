...
namespace Assignment
{
	...
	public class BSTree
	{
		...
		private Member Search(Member member, BTreeNode r)
		{
			if(r != null)
			{
				if(member.CompareTo(r.Member) == 0|| member.CompareTo(r.Member) == 2)
					return r.Member;
				else
				...
				return new Member("false","false","0","0");
		}
		...
		public bool Delete(Member member)
		{
			...
			while((ptr!=null)&&(member.CompareTo(ptr.Member)!=2))
			{
				parent = ptr;
